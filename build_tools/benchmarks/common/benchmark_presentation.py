...
METRIC_ID_MAP = {
    COMPILATION_TIME_SERIES_SUFFIX: COMPILATION_TIME_METRIC_ID,
    TOTAL_DISPATCH_SIZE_SERIES_SUFFIX: TOTAL_DISPATCH_SIZE_METRIC_ID,
    TOTAL_ARTIFACT_SIZE_SERIES_SUFFIX: TOTAL_ARTIFACT_SIZE_METRIC_ID,
}
